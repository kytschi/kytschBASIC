...
class Ellipsef extends Shape
{
	public function copyShape(
		...
		imagefilledellipse(image, self::x, self::y, self::width, self::height, colour);
	...
	public static function draw(
		...
		var args;
		let args = Args::parseShort("ELLIPSEF", command);
		...
		return output . "<?php imagefilledellipse($KBIMAGE, " . self::x . "," . self::y . "," . self::width . "," . self::height . ", $KBCOLOUR);?>;";
	}

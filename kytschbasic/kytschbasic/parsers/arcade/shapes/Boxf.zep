 ...
 * BOXF parser
 *
 * @package     KytschBASIC\Parsers\Arcade\Shapes\Boxf
 * @author 		Mike Welsh
...
class Boxf extends Shape
{
	...
	public function copyShape(
		...
		imagefilledrectangle(image, this->x1, this->y1, this->x2, this->y2, colour);
	...
	public function draw(
		...
		let args = controller->parseShort("BOXF", command);
		...
		return output . "<?php imagefilledrectangle($KBIMAGE, " . this->x1 . "," . this->y1 . "," . this->x2 . "," . this->y2 . ", $KBCOLOUR);";
	}
